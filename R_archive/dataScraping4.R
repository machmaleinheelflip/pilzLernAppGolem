...
process_species <- function(speciesKey) {
  # Load existing data
  if (file.exists("data_6.rds")) {
    old_data <- readRDS("data_6.rds")
...
# pbapply::pblapply(species_list$speciesKey[201:400], process_species)
